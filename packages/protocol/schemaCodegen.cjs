...
var schemaUri =
  'https://jenkins.ivyteam.io/job/core_json-schema/job/codecamp_2025_casemap_lsp/4/artifact/workspace/ch.ivyteam.ivy.casemap.editor.lsp.schema/target/schema/casemap/13.2.1/casemap-tsgen.json';
